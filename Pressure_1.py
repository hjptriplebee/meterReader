import json
from Common import *
from util import PlotUtil as plot, RasancFitCircle as rasan, DrawSector as ds, ROIUtil as roiutil
import math
...
def read(image, info):
    ...
    zhang_thinning = cleanNoisedRegions(zhang_thinning, info, src.shape) # 用zhang's 的算法得出的细化图
